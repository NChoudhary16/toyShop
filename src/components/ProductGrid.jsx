...
function sendWhatsApp(productName) {
  const phoneNumber = "917563087581"; 
  const message = `Hi, I'm interested in the ${productName} toy.`;
...
export default function ProductGrid() {
  return (
    <section id="collection" className="py-24 px-6 max-w-7xl mx-auto">
      <div className="mb-12">
        <h2 className="text-3xl font-serif italic text-[#2D4341]">
          The Seasonal Edit
        </h2>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {products.map((p, i) => (
          <div key={i} className="group cursor-pointer">
            ...
            <p className="text-[9px] uppercase tracking-widest text-[#DE8F6E] font-bold">
              {p.cat}
            </p>
